'''
Recoves light and shape but uses the data from facedetection.py to crop the image and then do the fitting
'''
import numpy as np
import sys
...
if __name__=="__main__":
	...
	imname='/Users/mudigonda/Data/faces/fwh/Tester_2/TrainingPose/pose_0.png'
	rect_name = '../data/Tester_1_pose_0_rect_0.txt'
	shape_name = '../data/Tester_1_pose_0_shape_0.txt'
